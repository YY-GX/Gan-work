...
writer = SummaryWriter('./log_mri')   #Tensorboard data
...
#     optimizer = torch.optim.Adam(model.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=False)
    ...
    # Data loading code
    traindir = '../gan_example/datasets/mr_ct/trainA/' #pure MRI
    valdir = '../gan_example/datasets/mr_ct/testA/'  #pure MRI
    normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                     std=[0.229, 0.224, 0.225])
    
    # from dataloader
    train_dataset = RgrDataset(
        'ct.csv', traindir, 'expe', 
        transforms.Compose([
