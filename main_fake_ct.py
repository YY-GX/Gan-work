...
writer = SummaryWriter('./log_fake_ct')
...
#     optimizer = torch.optim.Adam(model.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=False)
    ...
    # Data loading code
    traindir = 'datasets/together/train/mr2ct-pretrained/test_latest/images/'
    valdir = 'datasets/pure_mri/val/mr2ct_pretrained/test_latest/images/'
